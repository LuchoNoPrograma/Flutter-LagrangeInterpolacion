...
class ResultadoVista extends StatelessWidget {
  ...
  List<_ChartData> generateGraphPoints() {
    ...
    final coefficients = controller.getCoefs();

    for (double x = -10; x <= 10; x += step) {
      final y = controller.evaluar(x);
                      ...
                      child: ExpansionTile(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              children: [
                                // Mostrar solo los pasos de L_i(x) desde el controlador
                                for (var step in controller.obtenerPasosPorLi(index))
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 8.0),
                                    child: Math.tex(
                                      step,
